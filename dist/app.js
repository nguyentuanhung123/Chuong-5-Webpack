...
(() => {
            ...
            n = r.nmd(n),
                function () {
                    var u, i = "Expected a function",
                        ...
                        Kn = "(?:" + Sn + "|" + Un + ")?",
                        Vn = "[" + In + "]?",
                        Gn = Vn + Kn + "(?:" + Mn + "(?:" + [Bn, $n, Dn].join("|") + ")" + Vn + Kn + ")*",
                        Hn = "(?:" + [Ln, $n, Dn].join("|") + ")" + Gn,
                        Jn = "(?:" + [Bn + Sn + "?", Sn, $n, Dn, zn].join("|") + ")",
                        Yn = RegExp("['’]", "g"),
                        Qn = RegExp(Sn, "g"),
                        Xn = RegExp(Un + "(?=" + Un + ")|" + Jn + Gn, "g"),
                        nt = RegExp([Fn + "?" + Cn + "+" + qn + "(?=" + [En, Fn, "$"].join("|") + ")", Pn + "+" + Zn + "(?=" + [En, Fn + Nn, "$"].join("|") + ")", Fn + "?" + Nn + "+" + qn, Fn + "+" + Zn, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Wn, Hn].join("|"), "g"),
                        ...
                        ut = -1,
                        it = {};
                    it[L] = it[C] = it[T] = it[U] = it[B] = it[$] = it[D] = it[F] = it[M] = !0, it[_] = it[g] = it[S] = it[y] = it[W] = it[d] = it[b] = it[w] = it[x] = it[j] = it[A] = it[O] = it[I] = it[R] = it[E] = !1;
                    var ot = {};
                    ot[_] = ot[g] = ot[S] = ot[W] = ot[y] = ot[d] = ot[L] = ot[C] = ot[T] = ot[U] = ot[B] = ot[x] = ot[j] = ot[A] = ot[O] = ot[I] = ot[R] = ot[z] = ot[$] = ot[D] = ot[F] = ot[M] = !0, ot[b] = ot[w] = ot[E] = !1;
                    var ft = {
                        "\\": "\\",
                        "'": "'",
                        "\n": "n",
                    ...
                    var pr = Zt({
                        ...
                        vr = function n(t) {
                            var r, e = (t = null == t ? ht : vr.defaults(ht.Object(), t, vr.pick(ht, et))).Array,
                                ...
                                $n = Ln.call(kn),
                                Dn = ht._,
                                Fn = On("^" + Ln.call(Cn).replace(tn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                                Mn = _t ? t.Buffer : u,
                                Nn = t.Symbol,
                                Pn = t.Uint8Array,
                            ...
                            function ce(n, t, r, e) {
                                var u = -1,
                                    ...
                                    c = t.length;
                                if (!f) return a;
                                r && (t = Wt(t, Jt(r))), e ? (i = St, o = !1) : t.length >= 200 && (i = Qt, o = !1, t = new Kr(t));
                                n: for (; ++u < f;) {
                                    var l = n[u],
                                        s = null == r ? l : r(l);
                            ...
                            }, $r.prototype = Fr.prototype, $r.prototype.constructor = $r, Mr.prototype = Dr(Fr.prototype), Mr.prototype.constructor = Mr, Nr.prototype = Dr(Fr.prototype), Nr.prototype.constructor = Nr, Pr.prototype.clear = function () {
                            ...
                            function Ie(n, t, r) {
                                for (var i = r ? St : Et, o = n[0].length, f = n.length, a = f, c = e(f), l = 1 / 0, s = []; a--;) {
                                    var h = n[a];
                                    a && t && (h = Wt(h, Jt(t))), l = yr(h.length, l), c[a] = !r && (t || o >= 120 && h.length >= 120) ? new Kr(a && h) : u
                                }
                                h = n[0];
                                var p = -1,
                                    v = c[0];
                            ...
                            function We(n) {
                                return !(!Xo(n) || (t = n, Un && Un in t)) && (Jo(n) ? Fn : gn).test(Ui(n));
                                var t
                            }
                            ...
                            function Pe(n, t, r, e) {
                                var u = e ? Mt : Ft,
                                    ...
                                    o = t.length,
                                    f = n;
                                for (n === t && (t = Ou(t)), r && (f = Wt(n, Jt(r))); ++i < o;)
                            ...
                            function Fu(n) {
                                return Xu((function (t) {
                                    return t = Wt(t, Jt(ii())), Ve((function (r) {
                                        var e = this;
                            ...
                            function di(n) {
                                ...
                                var e = ri(r);
                                return !!e && n === e[0]
                            } (xr && si(new xr(new ArrayBuffer(1))) != W || jr && si(new jr) != x || Ar && si(Ar.resolve()) != k || kr && si(new kr) != I || Or && si(new Or) != E) && (si = function (n) {
                                var t = je(n),
                            ...
                            var To = yu((function (n, t) {
                                var r = (t = 1 == t.length && Po(t[0]) ? Wt(t[0], Jt(ii())) : Wt(_e(t, 1), Jt(ii()))).length;
                            ...
                            return $r.after = function (n, t) {
                                ...
                                return i.placeholder = n.placeholder, i
                            }, $r.debounce = Eo, $r.defaults = Af, $r.defaultsDeep = kf, $r.defer = So, $r.delay = Wo, $r.difference = $i, $r.differenceBy = Di, $r.differenceWith = Fi, $r.drop = function (n, t, r) {
                                var e = null == n ? 0 : n.length;
                            ...
                            }, $r.intersection = Zi, $r.intersectionBy = Ki, $r.intersectionWith = Vi, $r.invert = Rf, $r.invertBy = zf, $r.invokeMap = wo, $r.iteratee = ua, $r.keyBy = mo, $r.keys = Sf, $r.keysIn = Wf, $r.map = xo, $r.mapKeys = function (n, t) {
                                var r = {};
                                ...
                                return $e(n, oe(t, 1))
                            }, $r.memoize = Lo, $r.merge = Lf, $r.mergeWith = Cf, $r.method = ia, $r.methodOf = oa, $r.mixin = fa, $r.negate = Co, $r.nthArg = function (n) {
                                ...
                                return Po(n) ? Wt(n, Ti) : af(n) ? [n] : Ou(Ci(df(n)))
                            ...
                            }, $r.values = Ff, $r.valuesIn = function (n) {
                                ...
                                return pu(n || [], t || [], Je)
                            }, $r.zipWith = co, $r.entries = $f, $r.entriesIn = Df, $r.extend = wf, $r.extendWith = mf, fa($r, $r), $r.add = da, $r.attempt = Qf, $r.camelCase = Mf, $r.capitalize = Nf, $r.ceil = ba, $r.clamp = function (n, t, r) {
                            ...
                            }, $r.find = vo, $r.findIndex = Mi, $r.findKey = function (n, t) {
                            ...
                            }, $r.get = Of, $r.gt = Fo, $r.gte = Mo, $r.has = function (n, t) {
    ...
    r.g = function () {
        ...
        new Promise(((n, t) => {
            console.log("Hello World"), n("1000")
        })).then((n => {
            console.log(n)
